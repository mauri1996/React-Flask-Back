...
dfConsulta1 = df.select(df['Year'] , df['ArrDelay'] ,df['DepDelay'] , df['UniqueCarrier'])
...
dfConsulta1.repartition(1).write.format('com.databricks.spark.csv').save("./consulta2_.csv",header = 'true')
