...
dfConsulta1 = df.select(df['Year'] , df['ArrDelay'] ,df['DepDelay'] , df['UniqueCarrier'], df['WeatherDelay'])
...
# Filtra todas aquellas Aerolinas que tengan retrasos
dfConsulta1 = dfConsulta1.filter(dfConsulta1['WeatherDelay'] > 0)
...
os.rename(path_master+csv[0], path_master+"resultado3.csv")
